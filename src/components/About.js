    ...
    <div className="about_wrapper">
      ...
      <section className="about_search">
        ...
        <article className="about_article">
          ...
          <img className="about_img" src={img01} alt=""/>
        </article>
        <article className="about_article">
          ...
          <img className="about_img" src={img02} alt=""/>
        </article>
        <article className="about_article">
          ...
          <img className="about_img" src={img03_01} alt=""/>
          <p>And now, only Bar venues display.</p>
          <img className="about_img" src={img03_02} alt=""/>
        </article>
        <article className="about_article">
          ...
          <img className="about_img" src={img04_01} alt=""/>
          ...
          <img className="about_img" src={img04_02} alt=""/>
        </article>
        <article className="about_article">
          ...
          <p>Suppose you want to explore the currently loaded set of Venues in greater detail - in this scenario, you want to explore Marker 42.</p>
          <img className="about_img" src={img05_01} alt=""/>
          <p>Here, we panned, zoomed and clicked Marker 42.</p>
          <img className="about_img" src={img05_02} alt=""/>
        </article>
      </section>
      ...
      <section className="about_new_level_search">
        ...
        <article className="about_article">
          ...
          <img className="about_img" src={img06} alt=""/>
        </article>
        <article className="about_article">
          <div className="about_article_title">Pan to Desired Location:</div>
          <hr/>
          <p>You can pan any where on the map.  Try exploring a city you plan be visit, or exploring a city in a foreign country.</p>
          <img className="about_img" src={img07} alt=""/>
        </article>
        <article className="about_article">
          <div className="about_article_title">Load New Venues:</div>
          <p>Un-check "Pan w/o Fetch".  Grab Map and give it a nudge.&nbsp;&nbsp;New Venues display in the new Location.</p>
          <img className="about_img" src={img08} alt=""/>
        </article>
      </section>
      ...
      <section className="about_reset">
        ...
        <article className="about_article">
          ...
          <hr/>
          <img className="about_img" src={img09} alt=""/>
        </article>
      </section>
    </div>
  )
